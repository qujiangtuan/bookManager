...
<%@page import="com.bie.utils.StringUtil" %>
...
<body>
    ...
    <div class="no_1">
        <div class="nav">
            <div class="logo"><a href="main.jsp"><img src="img/Books-Store-Logo2.jpg" alt=""></a></div>
            <div class="title">
                <div class="search">
...
<!--                 </div> -->
                ...
                <div class="user-picture"><a href="login.jsp"><img src="img/user.PNG" alt=""></a>
